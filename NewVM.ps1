...
New-VM -Name TestJenkins-001 -VMHost 10.133.250.201 -GuestId fedora64Guest `
-NumCpu 4 -MemoryMB 16384 -DiskMB 16384 -Datastore DataStoreHDD -Version v12 -NetworkName 'PG WAN 1'
